...
const QUICK_LINKS = [
  { label: "Homework",  icon: <Entypo name="open-book" size={22} color="#1E88E5" />,            bg: "bg-blue-50",   route: "/dashboard/homework" },
  { label: "Calendar",  icon: <FontAwesome name="calendar" size={22} color="#7C3AED" />,         bg: "bg-violet-50", route: "/dashboard/calendar" },
  { label: "Gallery",   icon: <FontAwesome name="photo" size={22} color="#D97706" />,            bg: "bg-amber-50",  route: "/dashboard/gallery" },
];

const CLASSROOM_LINKS = [
  { label: "Attendance",    icon: <MaterialIcons name="how-to-reg" size={22} color="#16A34A" />,        bg: "bg-green-50",  route: "/dashboard/attendance" },
  { label: "Progress Card", icon: <Ionicons name="stats-chart" size={22} color="#DC2626" />,            bg: "bg-red-50",    route: "/dashboard/progress" },
  { label: "Time Table",    icon: <MaterialIcons name="table-chart" size={22} color="#0891B2" />,       bg: "bg-cyan-50",   route: "/dashboard/timetable" },
  { label: "Online Test",   icon: <MaterialIcons name="quiz" size={22} color="#7C3AED" />,              bg: "bg-violet-50", route: "/dashboard/test" },
  { label: "E-Books",       icon: <FontAwesome5 name="book-reader" size={20} color="#D97706" />,        bg: "bg-amber-50",  route: "/dashboard/ebooks" },
  { label: "Fee",           icon: <FontAwesome6 name="money-bill" size={20} color="#16A34A" />,         bg: "bg-green-50",  route: "/dashboard/fee" },
];

const COMMUNICATION_LINKS = [
  { label: "SMS",       icon: <MaterialIcons name="sms" size={22} color="#1E88E5" />,              bg: "bg-blue-50",   route: "/dashboard/sms" },
  { label: "Email",     icon: <MaterialIcons name="email" size={22} color="#7C3AED" />,            bg: "bg-violet-50", route: "/dashboard/email" },
  { label: "Notices",   icon: <FontAwesome6 name="bullhorn" size={20} color="#0891B2" />,          bg: "bg-cyan-50",   route: "/dashboard/circular" },
  { label: "Feedback",  icon: <MaterialIcons name="feedback" size={22} color="#D97706" />,         bg: "bg-amber-50",  route: "/dashboard/feedback" },
  { label: "Support",   icon: <MaterialIcons name="contact-support" size={22} color="#DC2626" />,  bg: "bg-red-50",    route: "/dashboard/support" },
];
      ...
      >
        ...
        <View className="bg-[#1E88E5]  py-6 px-5 rounded-br-[32px]">
          ...
          <View className="flex-row items-center gap-3.5 mt-2">
            ...
            <View className="flex-1">
              ...
              <Text className="text-[12px] text-white/80 mt-0.5">Class 10A  •  Roll No: 123</Text>
              <View className="bg-white/20 self-start px-2 py-0.5 rounded-full mt-1.5">
                <Text className="text-[11px] text-white font-medium">Student Account</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        >
          ...
          <SectionHeader
            ...
            label="Quick Links"
          />
          <LinkGrid items={QUICK_LINKS} onNavigate={handleNavigate} />
          ...
          <SectionHeader
            ...
            label="Classroom"
          />
          <LinkGrid items={CLASSROOM_LINKS} onNavigate={handleNavigate} />
          ...
          <SectionHeader
            ...
            label="Communication"
          />
          <LinkGrid items={COMMUNICATION_LINKS} onNavigate={handleNavigate} />
        </ScrollView>
